...
int main(){ // graphı almaya kadar temiz çalışıyor devamı bilinmiyor
    ...
    if(fptr == NULL){//dosya okunmasında sorunları kontrol ediyor,varsa dosyanın nerde olması gerektiğine bir örnek gösteriyorum.
    ...
    // ödev gereği en yüksek start, en düşük (yani 0) end olacaktır;
